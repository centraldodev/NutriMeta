...
export const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: Platform.OS === 'web' ? Spacing.xl : Spacing.base,
  ...
  scroll: { width: '100%', maxWidth: undefined, alignSelf: 'center', padding: Platform.OS === 'web' ? Spacing.xl : Spacing.base, paddingBottom: 110 },
  ...
  postGridRow: { gap: Spacing.base },
  postGridItem: { flex: 1, minWidth: 0 },
